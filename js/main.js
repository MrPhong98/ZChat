...
(function () {
    ...
    function applyAvatarFields(participant, row) {
        ...
        // Tick xanh verify (cột is_verified trên bảng users — mặc định false)
    ...
    async function syncMyAvatarFromServer(username) {
        ...
        try {
            const { data, error } = await window.supabaseClient
                .from("users")
                .select("username, avatar_type, avatar_color, avatar_emoji, avatar_url, recovery_password, is_verified")
                .ilike("username", me)
                .maybeSingle();
            ...
            // Tick xanh verify theo tài khoản
        ...
        <div class="min-w-0 flex-1">
          <div class="flex items-center justify-between gap-2">
            <span class="flex min-w-0 items-center gap-1.5 truncate">
              ...
              ${typeof getVerifiedBadge === "function" ? getVerifiedBadge(!!chat.participant.isVerified) : ""}
            </span>
    ...
    function renderActiveChat() {
        ...
        const verifiedBadge = typeof getVerifiedBadge === "function" ? getVerifiedBadge(!!chat.participant.isVerified) : "";
