...
(function () {
    ...
    function enterApp(username) {
        // Passcode: chưa unlock trong 50h → recovery.html (không đụng chat UI)
    ...
    function renderMessages(chat) {
        ...
        msgs.forEach((msg, i) => {
          ...
          <div class="flex items-center gap-3 rounded-bubble px-4 py-3 mb-1.5" style="background-color: var(--elevated);">
            ...
            // Seen chỉ dưới tin CUỐI của mình
            let seenHtml = "";
            if (isMine) {
                let lastMineIdx = -1;
            ...
            .on(
                ...
                async (payload) => {
                    try {
                        ...
                        // Tin optimistic của mình — gắn UUID, GIỮ plaintext, không render lại
                        if (isMineMsg) {
                ...
                async (payload) => {
                    try {
                        ...
                        if (rawContent) {
                            ...
                            // Chỉ edited khi plaintext thật sự đổi; không gán ciphertext
                            const stillCipher =
                                plain === rawContent &&
                                window.ZChatE2EE &&
